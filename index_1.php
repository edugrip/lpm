                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center">
                                <div class="hero-slide-content slider-animated-1">
                                    ...
                                    <h2 class="title-1">Life Pitch Marketing</h2>
                                    <p>A Multi-Level Marketing company incorporated in Malaysia. We provide a holistic approach of wellbeing.</p>
...
<!--    <div class="section pt-100px pb-100px">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            <h5 class="title"><a href="#">Hunix </a></h5>
                                            <span class="price">
                ...
                <div class="col-lg-6 col-12 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <a href="#" class="banner">
                        ...
                        <div class="info justify-content-end">
                            <div class="content align-self-left">
                ...
                <div class="col-lg-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <a href="#" class="banner">
                        ...
                        <div class="info justify-content-start">
                            <div class="content align-self-right">
    ...
    <div class="section pb-100px">
        <div class="container">
            ...
            <!-- section title start -->
            <div class="new-product-slider swiper-container slider-nav-style-1 swiper-container-initialized swiper-container-horizontal" data-aos="fade-up" data-aos-delay="200">
                <div class="new-product-wrapper swiper-wrapper" id="swiper-wrapper-9badef1ea1c328ec" aria-live="polite" style="transition: all 0ms ease 0s; transform: translate3d(-1200px, 0px, 0px);"><div class="new-product-item swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" role="group" aria-label="6 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="1">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/1.jpg" alt="Product">
                    ...
                    </div><div class="new-product-item swiper-slide swiper-slide-duplicate" role="group" aria-label="7 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="2">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/2.jpg" alt="Product">
                    ...
                    </div><div class="new-product-item swiper-slide swiper-slide-duplicate" role="group" aria-label="8 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="3">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/1.jpg" alt="Product">
                    ...
                    </div><div class="new-product-item swiper-slide swiper-slide-duplicate swiper-slide-prev" role="group" aria-label="9 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="4">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/1.jpg" alt="Product">
                    ...
                    <!-- Single Prodect -->
                    <div class="new-product-item swiper-slide swiper-slide-active" role="group" aria-label="5 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="0">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/2.jpg" alt="Product">
                    ...
                    <!-- Single Prodect -->
                    <div class="new-product-item swiper-slide swiper-slide-next" role="group" aria-label="6 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="1">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/2.jpg" alt="Product">
                    ...
                    <!-- Single Prodect -->
                    <div class="new-product-item swiper-slide" role="group" aria-label="7 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="2">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/1.jpg" alt="Product">
                    ...
                    <!-- Single Prodect -->
                    <div class="new-product-item swiper-slide" role="group" aria-label="8 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="3">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/1.jpg" alt="Product">
                    ...
                    <!-- Single Prodect -->
                    <div class="new-product-item swiper-slide swiper-slide-duplicate-prev" role="group" aria-label="9 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="4">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/2.jpg" alt="Product">
                    ...
                    <!-- Single Prodect -->
                <div class="new-product-item swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" role="group" aria-label="5 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="0">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/1.jpg" alt="Product">
                    ...
                    </div><div class="new-product-item swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" role="group" aria-label="6 / 13" style="width: 270px; margin-right: 30px;" data-swiper-slide-index="1">
                        <div class="product">
                            <div class="thumb">
                                <a href="#" class="image">
                                    <img src="assets/images/product-image/2.jpg" alt="Product">
                ...
                <!-- Add Arrows -->
                <div class="swiper-buttons">
                    <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-f52a169d86a8ce8b"></div>
                    <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f52a169d86a8ce8b"></div>
                </div>
